...
% If we want an good performing HPF, we could implement it as below
% It is the same as the LPF but with (-1)^n, which reverses the freq response
%delta = zeros(1,M);
%for i = 1:M
%    if mod(i,2) == 1
%        delta(i) = 1;
